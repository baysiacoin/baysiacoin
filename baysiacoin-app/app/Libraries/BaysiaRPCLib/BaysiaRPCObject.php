<?php
/**
 * Contains class BaysiaRPCObject
 *
 * @license MIT
 */

/**
 * A super class for all schemas used in BaysiaRPC.
 */
abstract class BaysiaRPCObject {
    /**
     * @protected
     */
     ...
     */
    const PATTERN_TYPE_RIPPLEADDRESS = "^g[1-9A-HJ-NP-Za-km-z]{25,33}$";
     ...
     * @protected
     */
    protected static function _fromNotification($x) { if(is_null($x)) return null; return ($x instanceof BaysiaRPCNotification) ? $x : new BaysiaRPCNotification($x); }
    /**
     * @protected
     */
    protected static function _checkNotification($x) { if(is_null($x)) return true; return ($x instanceof BaysiaRPCNotification); }
     ...
     * @protected
     */
    protected static function _fromOrder($x) { if(is_null($x)) return null; return ($x instanceof BaysiaRPCOrder) ? $x : new BaysiaRPCOrder($x); }
    /**
     * @protected
     */
    protected static function _checkOrder($x) { if(is_null($x)) return true; return ($x instanceof BaysiaRPCOrder); }
     ...
     * @protected
     */
    protected static function _fromAccountSettings($x) { if(is_null($x)) return null; return ($x instanceof BaysiaRPCAccountSettings) ? $x : new BaysiaRPCAccountSettings($x); }
    /**
     * @protected
     */
    protected static function _checkAccountSettings($x) { if(is_null($x)) return true; return ($x instanceof BaysiaRPCAccountSettings); }
     ...
     * @protected
     */
    protected static function _fromPayment($x) { if(is_null($x)) return null; return ($x instanceof BaysiaRPCPayment) ? $x : new BaysiaRPCPayment($x); }
    /**
     * @protected
     */
    protected static function _checkPayment($x) { if(is_null($x)) return true; return ($x instanceof BaysiaRPCPayment); }
     ...
     * @protected
     */
    protected static function _fromBalance($x) { if(is_null($x)) return null; return ($x instanceof BaysiaRPCBalance) ? $x : new BaysiaRPCBalance($x); }
    /**
     * @protected
     */
    protected static function _checkBalance($x) { if(is_null($x)) return true; return ($x instanceof BaysiaRPCBalance); }
     ...
     * @protected
     */
    protected static function _fromAmount($x) { if(is_null($x)) return null; return ($x instanceof BaysiaRPCAmount) ? $x : new BaysiaRPCAmount($x); }
    /**
     * @protected
     */
    protected static function _checkAmount($x) { if(is_null($x)) return true; return ($x instanceof BaysiaRPCAmount); }
     ...
     * @protected
     */
    protected static function _fromTrustline($x) { if(is_null($x)) return null; return ($x instanceof BaysiaRPCTrustline) ? $x : new BaysiaRPCTrustline($x); }
    /**
     * @protected
     */
    protected static function _checkTrustline($x) { if(is_null($x)) return true; return ($x instanceof BaysiaRPCTrustline); }
